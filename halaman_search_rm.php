...
$lama = 1;
$query = "DELETE FROM t_pasien WHERE DATEDIFF(CURDATE(), tanggal) > $lama";
...
<form method="post">
    ...
    <div class="contentform">
    	<div class="leftcontact">
				...
				<button type='submit' id="search" name="SearchRM">
	  ...
	  <input type="submit" class="bouton-contact" name="reg">
</form>	
	  <?php
        if ('POST' == $_SERVER['REQUEST_METHOD']) {
		   ...
		   else if (isset($_POST['SearchRM'])) {   
		 require_once "tombol_search_rm.php";
          }
		}
      ?>
<div id="coppyright">
