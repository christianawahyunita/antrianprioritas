	 ...
	 <div id="tabelantrian">
		  ...
		  <?php
			...
			$pilih_db = mysql_select_db($database) or die("Database tidak ada");
			 ...
			 $select_antrian="SELECT id_periksa, no_rm, nama_pasien, jenis_pembayaran FROM pasien WHERE prioritas=5 ORDER BY id_periksa ASC";
		  ...
		  <div id="nomorantrian">
			  <h2>NOMOR :</h2>
				  <div id="nomor_selanjutnya">
				  	<h1 id="nomorsaatini">
						<?php
							$select_antrian="SELECT id_periksa FROM pasien WHERE prioritas='5' ORDER BY id_periksa ASC LIMIT 1";
							$result=mysql_query($select_antrian);
